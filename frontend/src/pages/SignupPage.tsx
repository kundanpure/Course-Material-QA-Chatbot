...
import { Brain, Loader2, Eye, EyeOff, UserPlus, ArrowRight, Mail, RefreshCw } from 'lucide-react';
                ...
                <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-dark-700">
                    ...
                    <div className="relative mb-4">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-white dark:bg-dark-800 text-gray-500 dark:text-gray-400">or sign up with email</span>
                        </div>
                    </div>
